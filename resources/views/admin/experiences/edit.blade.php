                ...
                <div class="glass-card" style="padding:32px;">
                    ...
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px; margin-bottom:20px;">
                        ...
                        <div>
                            ...
                            @if($experience->location_photo)
                            <div style="margin-top:10px; display:flex; align-items:center; gap:8px;">
                                <img src="{{ $experience->location_photo_url }}" alt="Current location photo" style="width:60px; height:40px; object-fit:cover; border-radius:8px; border:1px solid rgba(0,242,255,0.3);">
                                <span style="font-size:10px; color:rgba(255,255,255,0.4);">Foto tempat terpasang</span>
                            </div>
                            @endif
                        </div>
                    </div>
