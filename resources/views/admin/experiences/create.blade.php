...
<div style="max-width:900px;">
    ...
    <div style="display:flex; align-items:center; gap:16px; margin-bottom:2.5rem;">
        ...
        <div>
            <h1 style="font-size:32px; font-weight:800; letter-spacing:-0.04em;">Add Experience</h1>
            ...
            <div style="display:flex; flex-direction:column; gap:24px;">
                <div class="glass-card" style="padding:32px;">
                    ...
                    <div style="margin-bottom:24px;">
                        ...
                        <input type="text" name="title" class="form-input" value="{{ old('title') }}" placeholder="e.g. Senior Frontend Developer" required>
                    </div>

                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px; margin-bottom:24px;">
                        <div>
                            <label class="form-label">Company / Institution <span style="color:#f87171;">*</span></label>
                            <input type="text" name="company" class="form-input" value="{{ old('company') }}" placeholder="e.g. Google Inc." required>
                        </div>
                        <div>
                            <label class="form-label">Location</label>
                            <input type="text" name="location" class="form-input" value="{{ old('location') }}" placeholder="e.g. Jakarta, Indonesia">
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom:24px;">
                        <label style="display:flex; align-items:center; gap:12px; cursor:pointer;">
                            <input type="checkbox" name="is_current" value="1" {{ old('is_current') ? 'checked' : '' }} style="width:18px; height:18px; accent-color:var(--brand);">
                    ...
                    <div style="margin-bottom:24px;">
                        ...
                        <textarea name="description" class="form-input" rows="6" placeholder="Jelaskan tanggung jawab, pencapaian, dan kontribusi utama kamu..." required style="resize:vertical; line-height:1.6;">{{ old('description') }}</textarea>
                    </div>
                </div>
                ...
                <div class="glass-card" style="padding:32px;">
                    ...
                    <div style="margin-bottom:24px;">
                        ...
                        <textarea name="highlights" class="form-input" rows="5" placeholder="Led migration to microservices architecture&#10;Reduced page load time by 40%&#10;Mentored team of 5 junior developers" style="resize:vertical; line-height:1.6; font-family:'JetBrains Mono', monospace; font-size:12px;">{{ old('highlights') }}</textarea>
            ...
            <div style="display:flex; flex-direction:column; gap:24px;">
                <div class="glass-card" style="padding:24px;">
                    <div style="margin-bottom:20px;">
                        ...
                        <input type="number" name="sort_order" class="form-input" value="{{ old('sort_order', 0) }}" min="0" placeholder="0">
                    ...
                    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:20px;">
                        ...
                        <label style="position:relative; display:inline-block; width:44px; height:24px;">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} style="opacity:0; width:0; height:0;" id="active-toggle">
