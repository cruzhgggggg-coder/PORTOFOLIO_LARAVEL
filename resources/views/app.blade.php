            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-16">
                ...
                <div class="col-span-1 md:col-span-5">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="{{ $profile['github_url'] }}" target="_blank" class="social-icon w-11 h-11 glass-premium flex items-center justify-center rounded-full text-white/60 hover:text-brand-primary text-sm font-medium">
                        ...
                        <a href="{{ $profile['twitter_url'] }}" target="_blank" class="social-icon w-11 h-11 glass-premium flex items-center justify-center rounded-full text-white/60 hover:text-brand-secondary text-sm font-medium">
                        ...
                        <a href="{{ $profile['linkedin_url'] }}" target="_blank" class="social-icon w-11 h-11 glass-premium flex items-center justify-center rounded-full text-white/60 hover:text-brand-accent text-sm font-medium">
